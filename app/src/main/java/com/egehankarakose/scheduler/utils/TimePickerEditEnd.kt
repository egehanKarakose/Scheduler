...
class TimePickerEditEnd : DialogFragment(), TimePickerDialog.OnTimeSetListener{
    ...
    override fun onTimeSet(view: TimePicker, hourOfDay: Int, minute: Int) {
        ...
        val tv: TextView = activity.findViewById(com.egehankarakose.scheduler.R.id.EditEventEndEditText) as TextView
